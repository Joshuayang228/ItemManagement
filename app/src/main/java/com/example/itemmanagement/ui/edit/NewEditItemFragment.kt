 ...
 */
class NewEditItemFragment : NewBaseItemFragment<NewEditItemViewModel>() {

    // 获取导航参数
    private val args: NewEditItemFragmentArgs by navArgs()

    // 获取编辑物品专用的 ViewModel
    override val viewModel: NewEditItemViewModel by viewModels {
        val repository = (requireActivity().application as ItemManagementApplication).repository
        NewEditItemViewModelFactory(repository, cacheViewModel, args.itemId)
    }
